...
export const EVAA_REWARDS_MASTER_TESTNET = Address.parse('kQDR7V5PPWXmNuA3nZuqXTVbnDv-tdItVtHtBeGH6aFXB7gu');
// export const EVAA_REWARDS_MASTER_MAINNET = Address.parse('EQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEVAA'); // inactive yet, will be impl soooooooon
...
export const EVAA_REWARDS_USER_CODE_TESTNET = Cell.fromBoc(
    Buffer.from(
        '',
        'hex',
    ),
)[0];

// export const EVAA_REWARDS_MASTER_CODE_MAINNET = Cell.fromBoc(Buffer.from('0x', 'hex'))[0]; // will be impl soooooooon
// export const EVAA_REWARDS_USER_CODE_MAINNET = Cell.fromBoc(Buffer.from('0x', 'hex'))[0]; // will be impl soooooooon
