...
import { ClassicCollector, Evaa, EvaaUser, MAINNET_POOL_CONFIG, UserDataActive } from '../../src';
...
describe('parseUserData test', () => {
    ...
    beforeAll(async () => {
        ...
        ClassicCollector = new ClassicCollector(MAINNET_POOL_CONFIG);
    ...
    test('test user without price', async () => {
        ...
        const dict: Dictionary<bigint, bigint> = (await ClassicCollector.getPrices()).dict;
