import { calculatePresentValue, DOGS_MAINNET, Evaa, EvaaUser, MAINNET_ALTS_POOL_CONFIG, MAINNET_POOL_CONFIG, NOT_MAINNET, presentValue, Prices, PricesCollector, RawPriceData, UserDataActive, verifyPricesSign, verifyRawPriceDataSign } from "../../src";
...
describe('parseAltsData test', () => {
    ...
    test('test NOT', async () => {
        ...
        const result = await clientMainNet.runMethod(MAINNET_ALTS_POOL_CONFIG.masterAddress, 'getAssetTotals', [{ type: "int", value: NOT_MAINNET.assetId }])
